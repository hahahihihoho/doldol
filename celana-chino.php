      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-11">
          <div class="aa-product-catg-content">
            <h2 style='text-align: center;'>Celana Chino</h2>
			...
			<?php
				$celanaall = $app->loadProdukCelanaChino();
			?>
              <p>Terdapat <b><?php echo count($celanaall); ?> produk</b> untuk Celana Chino</p>
