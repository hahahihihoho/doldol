...
<title>Kemeja Pria - Kemeja Batik Terbaru</title>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="aa-product-catg-content">
            <h2 style='text-align: center;'>Kemeja Batik</h2>
            <?php
              $kemejaall = $app->loadProdukKemejaBatik();
            ?> 
            <p style='text-align: center;'>Terdapat <b><?php echo count($kemejaall); ?> produk</b> untuk Kemeja Batik. Semua produk yang ada di Website <b>Ready Stock.</b></p>
