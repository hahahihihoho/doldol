      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-11">
          <div class="aa-product-catg-content">
            <h2 style='text-align: center;'>Atasan Pria</h2>
            <?php
              $atasanall = $app->loadProdukAtasanAll();
            ?>
            <p style='text-align: center;'>Terdapat <b><?php echo count($atasanall['listproduk']); ?> produk</b> untuk Atasan Pria. Semua produk yang ada di Website <b>Ready Stock.</b></p>
			...
			<?php 
				foreach($atasanall['listproduk'] as $atasan){
			?>
                <li>
                  <figure>
