      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-11">
          <div class="aa-product-catg-content">
            <h2 style='text-align: center;'>Celana Pria</h2>
            <?php
              $celanaall = $app->loadProdukCelanaAll();
            ?>
            <p style='text-align: center;'>Terdapat <b><?php echo count($celanaall['listproduk']); ?> produk</b> untuk Celana Pria. Semua produk yang ada di Website <b>Ready Stock.</b></p>
			...
			<?php 
				foreach($celanaall['listproduk'] as $celana){
			?>
                <li>
                  <figure>
